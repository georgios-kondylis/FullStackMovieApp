...
const MessageToUser = ({message}: Props) => {
  return (
    <p className={`absolute bottom-[-50px] left-0 px-5 py-2 text-center text-[16px] text-white bg-black/80 w-full mx-auto pointer-events-none rounded-[5px] text-nowrap
