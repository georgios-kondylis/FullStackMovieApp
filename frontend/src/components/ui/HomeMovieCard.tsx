...
const HomeMovieCard = ({movie, setSelectedMovie, bookmarked = false }:Props,) => {
  return (
    ...
    >
      ...
      <div className="flex w-[55px] h-[55px] border-[5px] rounded-[8px] backdrop-blur-[3px] border-[#111111] items-center justify-center absolute top-[-6px] left-[-5px] text-[25px] text-white group">
        {bookmarked? 
